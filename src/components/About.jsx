      ...
      <div className="md:container md:mx-auto">
        ...
        >
          ...
          <ul className="grid md:grid-cols-3 sm:grid-cols-2 gap-4">
            {skills.map((skill) => (
              <li className="bg-green-300 w-full hover:scale-105 duration-300 ease-in-out text-black flex flex-row justify-evenly items-center m-2 p-2 shadow-md shadow-green-400 rounded-xl">
